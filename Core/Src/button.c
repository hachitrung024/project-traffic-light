...
#include "button.h"
static GPIO_TypeDef * button_ports[MAX_BUTTONS] ={BT_MODE_GPIO_Port,BT_SET_GPIO_Port,BT_OK_GPIO_Port};
static uint16_t button_pins[MAX_BUTTONS] = {BT_MODE_Pin,BT_SET_Pin,BT_OK_Pin};
